...
class _HomeDataWidgetState extends ConsumerState<HomeDataWidget> {
  ...
  void openAnswerInput(int questionId) {
    setState(() {
      answerInputVisible.add(questionId);
      answerControllers[questionId] ??= TextEditingController();
    });
              ...
              child: Column(
                ...
                children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: isSolved
                              ? Colors.green
                              : Colors
                                  .red, // Green for solved, red for unsolved
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                  ...
                  if (question["tags"] != null &&
                      ...
                      question["tags"].toString().trim().isNotEmpty)
                    Wrap(
                      spacing: 8,
                      children: question["tags"]
                          ...
                          .where((tag) =>
                              tag.trim().isNotEmpty) // Remove empty tags
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height: vMin(context, 1.5)), // Reduced spacing
                          Text(
                  ...
                  if (answerInputVisible.contains(question["question_id"])) ...[
                    ...
                    // Wrap in Stack to Overlay Close Icon
                    Stack(
                      children: [
                        TextField(
                          controller:
                              answerControllers[question["question_id"]],
                        ...
                        Positioned(
                          right: 8, // Adjust distance from right
                          top: 8, // Adjust distance from top
