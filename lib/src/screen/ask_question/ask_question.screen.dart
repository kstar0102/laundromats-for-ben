...
class _AskQuestionScreenState extends ConsumerState<AskQuestionScreen> {
  ...
  void _pickImage(BuildContext context) async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp'], // Image formats
    );
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(color: kColorInputBorder),
                              ),
                              focusedBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8.0),
                                borderSide: const BorderSide(color: kColorInputBorder, width: 1.0),
                              ),
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  border: Border.all(color: kColorInputBorder, width: 1),
                                  borderRadius: BorderRadius.circular(8.0),
                                ),
                                child: Column(
