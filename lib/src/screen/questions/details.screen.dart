...
class _QuestionDetailScreenState extends ConsumerState<QuestionDetailScreen> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(padding: EdgeInsets.only(left: vMin(context, 4), right: vMin(context, 4), top: vMin(context, 4)),
                      child: SizedBox(
                    ...
                    Padding(padding: EdgeInsets.only(left: vMin(context, 4), right: vMin(context, 4)),
                      child: Wrap(
                        spacing: 8,
                        runSpacing: 0,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Wrap(
                              ...
                              runSpacing: 8.0,
                              children: [
                                _buildInfoCard("assets/images/icons/solar-tag.png", "Serial number", "17345678"),
                                _buildInfoCard("assets/images/icons/solar-tag.png", "Pounds", "175 lbs"),
                                _buildInfoCard("assets/images/icons/solar-box.png", "Brand", "Speed Queen"),
                                _buildInfoCard("assets/images/icons/solar-tag.png", "Year", "2017"),
                              ],
                            ),
                          ),
                        ],
                    ...
                    Padding(padding: EdgeInsets.only(left: vMin(context, 4), right: vMin(context, 4), top: vMin(context, 3)),
                      child: Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Image.asset("assets/images/icons/solar-pen.png"),
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: const TextStyle(color: kColorLightGrey, fontSize: 14, fontFamily: 'Onset-Regular',),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Image.asset("assets/images/icons/checklist.png"),
                              const SizedBox(width: 8.0),
                              Expanded(
                                child: Text(
                                  laundromatOwners.toString(),
                                  style: const TextStyle(
                                    fontFamily: 'Onset-Regular',
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(
                                      ...
                                      style: TextStyle(fontSize: 12, fontFamily: 'Onset-Regular', fontWeight: FontWeight.bold, color: kColorSecondary),
                                    ),
                                    SizedBox(height: vMin(context, 2)),
                                        ...
                                        SizedBox(
                                          ...
                                          child: ButtonWidget(
                                            ...
                                            onPressed: () {
                                              showDialog(
                                                context: context,
                                                builder: (context) => TipModal(onTipSubmit: (tipAmount) {
                                                }),
                                              );
                                            },
                                          ),
  ...
  Widget _buildInfoCard(String icon, String title, String value) {
    return Container(
      padding: EdgeInsets.only(top: vMin(context, 1), left: vMin(context, 2), right: vMin(context, 2), bottom: vMin(context, 1)),
      decoration: BoxDecoration(
